...
internalState2 = totalstate(2 * netDim + 1:3 * netDim);
internalState3 = totalstate(3 * netDim + 1:4 * netDim);
internalState4 = totalstate(4 * netDim + 1:5 * netDim);

intWM0 = intWM0 * specRad;
intWM1 = intWM1 * specRad;
intWM2 = intWM2 * specRad;
intWM3 = intWM3 * specRad;
intWM4 = intWM4 * specRad;
intWM = blkdiag(intWM0,intWM1,intWM2,intWM3,intWM4);

ofbWM0 = ofbWM0 * diag(ofbSC);
ofbWM1 = ofbWM1 * diag(ofbSC);
ofbWM2 = ofbWM2 * diag(ofbSC);
ofbWM3 = ofbWM3 * diag(ofbSC);
ofbWM4 = ofbWM4 * diag(ofbSC);
ofbWM = [ofbWM0',ofbWM1',ofbWM2',ofbWM3',ofbWM4']';
outWM = initialOutWM;
...
trainNRMSE = [trainNRMSE,sqrt(msetrain ./ teacherVariance)'];
testNRMSE = [testNRMSE,sqrt(msetestresult ./ teacherVariance)'];
