...
%     sampleout(1,n) = 0.3*sampleout(1,n-1) + 0.05*sampleout(1,n-1) ...
%         *sum(sampleout(1,n-10:n-1)) + 0.5*sampleinput(1,n-9) ...
%         *sampleinput(1,n-1) +0.1
    
%     sampleout(1,n) = sampleinput(1,n-5) * sampleinput(1,n-10) ...
%         + sampleinput(1,n-2) * sampleout(1,n-2);
    
    sampleout(1,n) = sampleinput(1,n-1) * sampleinput(1,n-3) ...
        + sampleinput(1,n-2) * sampleout(1,n-2);
end
