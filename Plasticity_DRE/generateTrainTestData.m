...
sampleinput = [rand(1,samplelength);rand(1,samplelength)];

 % use this input sequence to drive a NARMA equation
systemorder = 10;
sampleout = 0.1*ones(outputLength,samplelength);
for n = systemorder +1 : samplelength
    ...
    sampleout(1,n) = sampleinput(2,n-5) * sampleinput(2,n-10) ...
        ...
        + sampleinput(1,n-1) * sampleinput(1,n-3) ...
        + sampleinput(2,n-4) * sampleinput(1,n-7);
